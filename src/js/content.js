const PLATFORM_ICONS = {
  ...
  pixiv: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M4.935 0A4.924 4.924 0 0 0 0 4.935v14.13A4.924 4.924 0 0 0 4.935 24h14.13A4.924 4.924 0 0 0 24 19.065V4.935A4.924 4.924 0 0 0 19.065 0zm7.81 4.547c2.181 0 4.058.676 5.399 1.847a6.118 6.118 0 0 1 2.116 4.66c.005 1.854-.88 3.476-2.257 4.563-1.375 1.085-3.217 1.69-5.258 1.69-2.04 0-3.878-.61-5.252-1.694-1.374-1.087-2.26-2.709-2.258-4.56a6.12 6.12 0 0 1 2.122-4.663c1.34-1.17 3.213-1.843 5.388-1.843zM3.24 17.27h4.7v3.49H3.24zm9.505-10.7c-1.552 0-2.89.49-3.842 1.3a4.34 4.34 0 0 0-1.5 3.285 4.34 4.34 0 0 0 1.498 3.28c.95.81 2.29 1.301 3.844 1.301 1.554 0 2.895-.49 3.847-1.3a4.34 4.34 0 0 0 1.5-3.281 4.34 4.34 0 0 0-1.502-3.286c-.95-.81-2.293-1.3-3.845-1.3z"/></svg>',
